...
include 'config.php';
if (count($_POST) > 0) {
    mysqli_query($connection, "UPDATE status_kumbalgamuwa set color='" . $_POST['new_color'] .  "' WHERE id='" . $_POST['userid'] . "'");
    header("Location:./kumbalagama.php");
}
$result = mysqli_query($connection, "SELECT * FROM status_kumbalgamuwa  WHERE id='" . $_GET['id'] . "'");
