...
include 'config.php';
if (count($_POST) > 0) {
    mysqli_query($connection, "UPDATE status_deduruoya set color='" . $_POST['new_color'] .  "' WHERE id='" . $_POST['userid'] . "'");
    header("Location:./deduruoya.php");
}
$result = mysqli_query($connection, "SELECT * FROM status_deduruoya  WHERE id='" . $_GET['id'] . "'");
