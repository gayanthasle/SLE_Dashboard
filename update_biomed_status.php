...
include 'config.php';
if (count($_POST) > 0) {
    mysqli_query($connection, "UPDATE status_biomed set color='" . $_POST['new_color'] .  "' WHERE id='" . $_POST['userid'] . "'");
    header("Location:./biomed.php");
}
$result = mysqli_query($connection, "SELECT * FROM status_biomed  WHERE id='" . $_GET['id'] . "'");
