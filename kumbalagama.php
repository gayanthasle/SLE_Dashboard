...
<div class="content">
    ...
    <div class="card">
        <div class="cot">
            <div class="img">
                ...
                $sql = "SELECT * FROM plant_image WHERE plant = 'kumbalgamuwa' ORDER BY id DESC LIMIT 1";
                $result = mysqli_query($connection, $sql);
                $image_name = $result->fetch_assoc();

                if (!empty($image_name['image_1'])) {
                    echo '<a href="uploads/kumbalgamuwa/' . htmlspecialchars($image_name['image_1']) . '" target="_blank">
                            <img src="uploads/kumbalgamuwa/' . htmlspecialchars($image_name['image_1']) . '" alt="">
                          </a>';
                }
                ?>
            </div>
        ...
        <div class="cot">
            <div class="img">
                ...
                if (!empty($image_name['image_2'])) {
                    echo '<a href="uploads/kumbalgamuwa/' . htmlspecialchars($image_name['image_2']) . '" target="_blank">
                            <img src="uploads/kumbalgamuwa/' . htmlspecialchars($image_name['image_2']) . '" alt="">
                          </a>';
                }
                ?>
            </div>
        ...
        <div class="cot">
            <div class="img">
                ...
                if (!empty($image_name['image_3'])) {
                    echo '<a href="uploads/kumbalgamuwa/' . htmlspecialchars($image_name['image_3']) . '" target="_blank">
                            <img src="uploads/kumbalgamuwa/' . htmlspecialchars($image_name['image_3']) . '" alt="">
                          </a>';
                }
                ?>
            </div>
        ...
        <div class="cot">
            <div class="img">
                ...
                if (!empty($image_name['image_4'])) {
                    echo '<a href="uploads/kumbalgamuwa/' . htmlspecialchars($image_name['image_4']) . '" target="_blank">
                            <img src="uploads/kumbalgamuwa/' . htmlspecialchars($image_name['image_4']) . '" alt="">
                          </a>';
                }
                ?>
            </div>
    ...
    <table id="deduruoya_table" class="plant_table">
        ...
        <tbody>
            <!-- date unit values display -->
            <tr>
                <?php
                require_once 'config.php';
                $query = "SELECT * FROM kumbalgamuwa
                        ORDER BY id DESC
                        LIMIT 1";
    ...
    <div class="row">
        <div class="cell">
            <h2 style="margin-bottom: 30px;">Kumbalgamuwa Generation</h2>
