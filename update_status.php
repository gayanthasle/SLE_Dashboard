...
include 'config.php';
if (count($_POST) > 0) {
    mysqli_query($connection, "UPDATE status set color='" . $_POST['new_color'] .  "' WHERE id='" . $_POST['userid'] . "'");
    header("Location:./dashboard.php");
}
$result = mysqli_query($connection, "SELECT * FROM status WHERE id='" . $_GET['id'] . "'");
